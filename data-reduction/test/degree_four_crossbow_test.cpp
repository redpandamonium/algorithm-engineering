...
namespace {
    ...
    class data_reduction_degree_4_crossbow : public Test {
    protected:

        static const data_reduction_options config;
    };

    const data_reduction_options data_reduction_degree_4_crossbow::config{"exhaustive", 0,
                                                                      {{"degree-4-crossbow", 0, {}}}};

    TEST_F(data_reduction_degree_4_crossbow, standard_accept) {
        graph g;
    ...
    TEST_F(data_reduction_degree_4_crossbow, neighbor_clique_accept) {
        graph g;
        auto vertex = g.add_vertex();
        auto v1 = g.add_vertex();
        auto v2 = g.add_vertex();
    ...
    TEST_F(data_reduction_degree_4_crossbow, standard_reject) {
        graph g;
        auto vertex = g.add_vertex();
        auto v1 = g.add_vertex();
        auto v2 = g.add_vertex();
