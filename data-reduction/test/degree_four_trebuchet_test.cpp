//
// Created by Carsten Schubert on 2019-02-18.
//
...
namespace {
    ...
    class data_reduction_degree_4_trebuchet : public Test {
    protected:

        static const data_reduction_options config;
    };

    const data_reduction_options data_reduction_degree_4_trebuchet::config{"exhaustive", 0,
                                                                          {{"degree-4-trebuchet", 0, {}}}};

    TEST_F(data_reduction_degree_4_trebuchet, standard_accept) {
        graph g;
    ...
    TEST_F(data_reduction_degree_4_trebuchet, neighbor_clique_accept) {
        graph g;
        auto vertex = g.add_vertex();
        auto v1 = g.add_vertex();
        auto v2 = g.add_vertex();
        ...
        controller.include_into_vertex_cover(v3_n);
    ...
    TEST_F(data_reduction_degree_4_trebuchet, standard_reject) {
        graph g;
        auto vertex = g.add_vertex();
        auto v1 = g.add_vertex();
        auto v2 = g.add_vertex();
