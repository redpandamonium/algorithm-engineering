...
namespace
{
    ...
    TEST(depth_first_search, order)
    {
        ...
        std::vector<std::vector<vertex::id_type>> possible_orderings =
        {
            ...
            {v0, v1, v2, v5, v6, v4, v3},
            {v0, v1, v2, v6, v5, v3, v4},
            {v0, v1, v2, v6, v5, v4, v3},
            {v0, v2, v1, v5, v6, v3, v4},
            {v0, v2, v1, v5, v6, v4, v3},
            {v0, v2, v1, v6, v5, v3, v4},
            {v0, v2, v1, v6, v5, v4, v3},
        };
